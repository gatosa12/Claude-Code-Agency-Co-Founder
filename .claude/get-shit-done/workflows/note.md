...
- **Global scope**: `/Users/alejopijuan/Projects/voice-ai-agency-ops-hub/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/alejopijuan/Projects/voice-ai-agency-ops-hub/.claude/notes/`)
...
2. Glob `/Users/alejopijuan/Projects/voice-ai-agency-ops-hub/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/alejopijuan/Projects/voice-ai-agency-ops-hub/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/alejopijuan/Projects/voice-ai-agency-ops-hub/.claude/notes/` — works in any directory
